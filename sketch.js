...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   air_2 = createImg('baloon2.png');
   air_2.position(260,370);
   air_2.size(120,120);
  ...
  bunny.scale = 0.2;
  star_01 = createSprite(320,50,20,20)
  star_01.addImage(star_1);
  star_01.scale = 0.025
  star_02 = createSprite(50,350)
...
function Air(){
  if(fruit.position.x > 250 && fruit.position.x<330){
